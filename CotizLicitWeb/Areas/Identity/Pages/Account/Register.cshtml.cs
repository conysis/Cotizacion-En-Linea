...
namespace CotizLicitWeb.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<CotizLicitWebUser> _signInManager;
        private readonly UserManager<CotizLicitWebUser> _userManager;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<CotizLicitWebUser> userManager,
            SignInManager<CotizLicitWebUser> signInManager,
